...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  shipmentNumber: "exampleShipmentNumber",
  ...
  test("POST /shipments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        shipmentDate: CREATE_RESULT.shipmentDate.toISOString(),
      ...
      .expect([
        {
          ...
          shipmentDate: FIND_MANY_RESULT[0].shipmentDate.toISOString(),
  ...
  test("GET /shipments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        shipmentDate: FIND_ONE_RESULT.shipmentDate.toISOString(),
        expectedDeliveryDate:
